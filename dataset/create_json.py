...
#####################################################################
#   Helper: Extract text and corresponding summary from data file   #
#####################################################################
def get_text_summary(filePath):
    ...
    highlight_start = 0
    lines = [line.replace("\n", '') for line in lines]
    lines = [line.replace("cnn", '') for line in lines]
...
#######################################################################################
#   Helper: Converts to lower case, removes extraneous characters and double spaces   #
#######################################################################################
